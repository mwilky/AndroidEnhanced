...
class SystemUIApplication {
    ...
    companion object {
        ...
        fun init(classLoader: ClassLoader?) {
            findAndHookMethod(SYSTEM_UI_APPLICATION_CLASS,
                classLoader,
                "onCreate",
                object : XC_MethodHook() {
                    override fun afterHookedMethod(param: MethodHookParam) {
                        ...
                        hookedContext?.let {
                            ...
                            Utils.SystemUIApplicationContextRef = SystemUIApplicationContextRef
                            ...
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.smartPulldown, param.thisObject.toString(), 0
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.quickPulldown, param.thisObject.toString(), 0
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext,
                            ...
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.qsStyle, param.thisObject.toString(), 0
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.qsColumns, param.thisObject.toString(), 2
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext,
                            ...
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.qqsColumns, param.thisObject.toString(), 2
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext,
                            ...
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.qqsRows, param.thisObject.toString(), 2
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.qsRows, param.thisObject.toString(), 4
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext,
                            ...
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext,
                                Utils.hideCollapsedWifiIcon,
                                param.thisObject.toString(),
                                false
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext, Utils.iconBlacklist, param.thisObject.toString(), ""
                            )
                            BroadcastUtils.registerBroadcastReceiver(
                                hookedContext,
